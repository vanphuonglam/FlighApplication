...
Objectonwebpage
    Element Text Should Be    xpath://*[@class='box']//h1    My Account
    Page Should Contain Element    xpath://*[@type='email']
    Page Should Contain Element    xpath://input[@type='password']
    Page Should Contain Element    xpath://*[@name='SignIn']
...
Login
    ${username}    Load Excel Data    Sheet1    TC07    User
    ${password}    Load Excel Data    Sheet1    TC07    Pass
    Select Frame    id=iframe-015
    Page Should Contain Element    //*[@class="box"]/h1
